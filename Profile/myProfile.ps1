...
<#
this may not work properly in all PowerShell hosts
dot source this script in your PowerShell profile to make it your default prompt
Sample prompt:
┌──────────────────────────────────────────────────────────────────────────────────────┐
...
$title="[{0}{1}{2} as {3}]  {4}" -f $elapsed,([char]0x25ba),$env:computername,$as,(Get-Location)
